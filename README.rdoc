...
== Usage: Raw URL
  ...
  RestClient.post "http://example.com/resource", xml_payload, :content_type => 'application/xml'


  RestClient.post "http://example.com/resource", xml_payload, {:content_type => 'application/xml', :params => {:param1 => 1, :param2 => 'bla'}}
